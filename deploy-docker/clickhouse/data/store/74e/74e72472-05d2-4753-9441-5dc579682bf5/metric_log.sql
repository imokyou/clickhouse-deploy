ATTACH TABLE _ UUID '7a4e2071-64f5-4509-be31-4d0b02de57f7'
(
    ...
    `ProfileEvent_DistrCacheReadErrors` UInt64 COMMENT 'Distributed Cache client event. Number of distributed cache errors during read',
    ...
    `ProfileEvent_DistrCachePackets` UInt64 COMMENT 'Distributed Cache client event. Total number of packets received from distributed cache',
    `ProfileEvent_DistrCacheDataPacketsBytes` UInt64 COMMENT 'Distributed Cache client event. The number of bytes in Data packets which were not ignored',
    ...
    `ProfileEvent_ParquetFetchWaitTimeMicroseconds` UInt64 COMMENT 'Time of waiting fetching parquet data',
    ...
    `CurrentMetric_ParquetDecoderIOThreads` Int64 COMMENT 'Number of threads in the ParquetBlockInputFormat io thread pool.',
    `CurrentMetric_ParquetDecoderIOThreadsActive` Int64 COMMENT 'Number of threads in the ParquetBlockInputFormat io thread pool running a task.',
    `CurrentMetric_ParquetDecoderIOThreadsScheduled` Int64 COMMENT 'Number of queued or active jobs in the ParquetBlockInputFormat io thread pool.',
    ...
    `CurrentMetric_VectorSimilarityIndexCacheCells` Int64 COMMENT 'Number of entries in vector similarity index cache',
    ...
    `CurrentMetric_TotalMergeFailures` Int64 COMMENT 'Number of all failed merges since startup, including the ones that were aborted',
    `CurrentMetric_NonAbortedMergeFailures` Int64 COMMENT 'Number of failed merges since startup, excluding the merges that were aborted',
